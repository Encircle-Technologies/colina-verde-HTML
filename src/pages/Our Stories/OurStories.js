...
function OurStories() {
	...
	return (
		<React.Fragment>
			...
			<section className="banner-wrapper small-banner relative">
				<div className="banner-img w-full h-full block relative overflow-hidden">
					<div className='img landscape'>
						<img src="../images/our-stories-banner.jpg" className='w-full h-full object-cover' width={1440} height={677} alt="Our Stories" loading='eager' />
					</div>
				</div>
            ...
            {/* story Start */}
            <section className='story-single-list bg-white-300 py-100 lgscreen:py-50'>
                <div className='container-fluid-md'>
                    <div className='flex flex-wrap items-center justify-center w-full m-0 p-0 mb-60 lgscreen:mb-40'>
                        <div className='title title-blue-200 mb-15'>
                            <h2 className='big'>
                                the latest from us
                            </h2>
                        </div>
                        <div className='content blue-100'>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.
                            </p>
                        </div>
                    </div>
                    <div className='w-full xl:max-w-[1142px] mx-auto'>
                        <div className='flex flex-wrap lgscreen:flex-col items-center relative w-full m-0 p-0'>
                            <div className='w-full lg:w-6/12'>
                                <div className='img landscape'>
                                    <img src='../images/story1.jpg' width={586} height={348} loading="lazy"  alt=''/>
                                </div>
                            </div>
                            <div className='w-full lg:w-6/12'>
                                <div className='flex flex-col w-full lg:max-w-[473px] lg:mx-auto m-0 p-0 items-start justify-center relative'>
                                    <div className='title title-blue-100 mb-[12px]'>
                                        <span className='mb-[12px] block'>
                                            02/27/2018
                                        </span>
                                        <h5 className='small'>
                                            Beginning 2018 with Gratitude ~ News from Colina Verde Mozambique
                                        </h5>
                                    </div>
                                    <div className='content blue-100 mb-30 last:mb-0 w-full max-w-[412px]'>
                                        <p>
            ...
            {/* story Start */}
            <section className='story-list py-100 lgscreen:py-50'>
                <div className='container-fluid-md'>
                    <div className='w-full xl:max-w-[1142px] mx-auto'>
                        <div className='flex flex-wrap lgscreen:flex-col items-center relative w-full m-0 mb-[75px] lgscreen:mb-40 p-0'>
                            <div className='w-full lg:w-6/12'>
                                <div className='img landscape'>
                                    <img src='../images/story2.jpg' width={586} height={348} loading="lazy"  alt=''/>
                                </div>
                            </div>
                            <div className='w-full lg:w-6/12'>
                                <div className='flex flex-col w-full lg:max-w-[473px] lg:mx-auto m-0 p-0 items-start justify-center relative'>
                        ...
                        <div className='flex flex-wrap lgscreen:flex-col items-center relative w-full m-0 mb-[75px] lgscreen:mb-40 p-0'>
                            <div className='w-full lg:w-6/12'>
                                <div className='img landscape'>
                                    <img src='../images/story3.jpg' width={586} height={348} loading="lazy"  alt=''/>
                                </div>
                            </div>
                            <div className='w-full lg:w-6/12'>
                                <div className='flex flex-col w-full lg:max-w-[473px] lg:mx-auto m-0 p-0 items-start justify-center relative'>
                    ...
                    <div className='btn-custom block text-center mt-[141px] lgscreen:mt-40'>
                        <Link to='/'className='btn btn-blue-200-link btn-loadmore'>
                            Load more of our stories
                        </Link>
                    </div>
                </div>
            </section>
