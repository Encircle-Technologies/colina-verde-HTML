...
function Gallery() {
	...
	return (
		<React.Fragment>
			...
			<section className="banner-wrapper small-banner relative">
				<div className="banner-img w-full h-full block relative overflow-hidden">
					<div className='img landscape'>
						<img src="../images/gallery-banner.jpg" className='w-full h-full object-cover' width={1440} height={677} alt="Gallery" loading='eager' />
					</div>
				</div>
			...
			{/* accordion Start */}
			<section className='gallery-details bg-white-300 relative pt-100 pb-[65px] lgscreen:py-50'>
				<div className='container-fluid-md'>
					<div className='flex flex-wrap items-center justify-between m-0 p-0 w-full relative lgscreen:gap-5'>
						<div className='block w-full lg:max-w-[70%] text-center lg:text-left'>
							<div className='title title-blue-200 mb-15'>
								<h2>
                                    the full experience in images
								</h2>
							</div>
                        ...
                        <div className='block w-full relative mt-30'>
                            <ul className='tabs w-full flex flex-row overflow-y-hidden gap-x-5 gap-y-5'>
                                <li onClick={() => { setTabOption('all') }} className={`tab-link cursor-pointer text-16 tracking-04em text-blue-100 text-opacity-60 font-900 uppercase font-bold ${(tabOption == 'all') ? 'tab-current' : ''}`}>All Images</li>
                                <li onClick={() => { setTabOption('house') }} className={`tab-link cursor-pointer text-16 tracking-04em text-blue-100 text-opacity-60 font-900 uppercase font-bold ${(tabOption == 'house') ? 'tab-current' : ''}`}>The House</li>
                                <li onClick={() => { setTabOption('rooms') }} className={`tab-link cursor-pointer text-16 tracking-04em text-blue-100 text-opacity-60 font-900 uppercase font-bold ${(tabOption == 'rooms') ? 'tab-current' : ''}`}>The rooms</li>
                                <li onClick={() => { setTabOption('activities') }} className={`tab-link cursor-pointer text-16 tracking-04em text-blue-100 text-opacity-60 font-900 uppercase font-bold ${(tabOption == 'activities') ? 'tab-current' : ''}`}>Activities</li>
                                <li onClick={() => { setTabOption('location') }} className={`tab-link cursor-pointer text-16 tracking-04em text-blue-100 text-opacity-60 font-900 uppercase font-bold ${(tabOption == 'location') ? 'tab-current' : ''}`}>Location</li>
                            </ul>
                        </div>
					</div>
				</div>
            ...
            {/* gallery grid Start */}
            <section className='gallery-grid py-80 lgscreen:py-50'>
                <div className='container-fluid-md'>
                    <div className="tabs-container">                            
                        {tabOption == 'all' && <div className='tabs-content'>
                            <div id="overview" className="tab-content w-full">
                                <div className='grid grid-cols-3 lgscreen:grid-cols-2 smscreen:grid-cols-1 w-full relative m-0 p-0 gap-8'>
                                    <div className='img landscape'>
                                        <img src='../images/img01.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                    <div className='img landscape'>
                                        <img src='../images/img02.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                    <div className='img landscape'>
                                        <img src='../images/img03.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                    <div className='img landscape'>
                                        <img src='../images/img04.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                    <div className='img landscape'>
                                        <img src='../images/img05.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                    <div className='img landscape'>
                                        <img src='../images/img06.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                    <div className='img landscape'>
                                        <img src='../images/img07.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                    <div className='img landscape'>
                                        <img src='../images/img08.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                    <div className='img landscape'>
                                        <img src='../images/img09.jpg' width={412} height={313} loading="lazy" alt="img"/>
                                    </div>
                                </div>
                                <div className='btn-custom block text-center mt-[80px] lgscreen:mt-40'>
                                    <Link to='/'className='btn btn-blue-200-link btn-loadmore'>
                                        Load More of our images
                                    </Link>
                                </div>
                            </div>
                        </div>}

                        {tabOption == 'house' && <div className='tabs-content'>
                            <div id="overview" className="tab-content w-full">
                                <div className='grid grid-cols-3 lgscreen:grid-cols-2 smscreen:grid-cols-1 w-full relative m-0 p-0 gap-8'>
                                    <div className='img landscape'>
                                        <img src='../images/img04.jpg' width={412} height={313} loading="lazy" alt="img"/>
