...
function Active() {
	...
	return (
		<React.Fragment>
				...
				<div className="banner-content flex flex-col justify-end items-center w-full h-full z-1 absolute top-0 left-0">
					<div className='container-fluid text-center w-full'>
						<div className='banner-heading'>
							<h1 className="text-white-100 font-400 font-primary">Activities</h1>
						</div>
						<div className='content white w-full md:max-w-[696px] mx-auto mb-25'>
							<p>
								We hope your stay will include plenty of time to simply relax and enjoy the beauty of the natural surroundings but there are also plenty of ways to explore and discover.
							</p>
						</div>
					</div>
				</div>
			...
			{/* Area Grid Start */}
			<section className='stay-grid bg-white-300 relative py-100 lgscreen:py-50'>
				<div className='container-fluid-md'>
					<div className='flex flex-wrap items-center justify-between m-0 p-0 w-full relative lgscreen:gap-5 mb-40'>
						<div className='block w-full lg:max-w-[70%]'>
							...
							<div className='content blue-100 mb-30 last:mb-0'>
								<p>
					...
					<div className='grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 m-0 p-0 relative w-full gap-x-[30px] gap-y-[75px] lgscreen:gap-[30px]'>
						<div className='stay-box'>
							<div className='img portrait'>
								<img src="../images/grid-Snorkelling.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Snorkelling" loading='lazy' />
							</div>
							<div className={`overlay-content duration-300 delay-150 ease-linear ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
										<h5>
											Snorkelling
										</h5>
									</div>							
									<div className={`content white duration-300 delay-150 ease-linear h-0`}>
										<p>
											Take a relaxing sunset paddle around the mangroves on one of our sturdy sea kayaks or explore the waters around Inhaca after our picnic lunch.
										</p>
									</div>	
								</div>
								<div className='btn-custom'>
									<button onClick={ToggleClass} className='btn btn-white-link'>
						...
						<div className='stay-box'>
							<div className='img portrait'>
								<img src="../images/grid-IslandPicnics.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Island Picnics" loading='lazy' />
							</div>
							<div className={`overlay-content duration-300 delay-150 ease-linear ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
						...
						<div className='stay-box'>
							<div className='img portrait'>
								<img src="../images/grid-SandBoarding.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Sand Boarding" loading='lazy' />
							</div>
							<div className={`overlay-content duration-300 delay-150 ease-linear ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
						...
						<div className='stay-box'>
							<div className='img portrait'>
								<img src="../images/grid-FatBikes.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Fat Bikes" loading='lazy' />
							</div>
							<div className={`overlay-content duration-300 delay-150 ease-linear ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
						...
						<div className='stay-box'>
							<div className='img portrait'>
								<img src="../images/grid-Snorkelling.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Kayaking" loading='lazy' />
							</div>
							<div className={`overlay-content duration-300 delay-150 ease-linear ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
						...
						<div className='stay-box'>
							<div className='img portrait'>
								<img src="../images/grid-Tennis.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Tennis" loading='lazy' />
							</div>
							<div className={`overlay-content duration-300 delay-150 ease-linear ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
					...
					<div className='btn-custom text-center mt-90 lgscreen:mt-40'>
						<Link to="/" className='btn btn-blue-200-link'>
							<span>
								Load All included experiences
							</span>
						</Link>
					</div>
				</div>
			...
			{/* Area Grid Start */}
			<section className='area-grid relative py-100 lgscreen:py-50'>
				<div className='container-fluid-md'>
					<div className='flex flex-wrap items-center justify-between m-0 p-0 w-full relative lgscreen:gap-5 mb-40'>
						<div className='block w-full lg:max-w-[70%]'>
					...
					<div className='grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 m-0 p-0 relative w-full gap-x-[30px] gap-y-[75px] lgscreen:gap-[30px]'>
						<div className='area-box'>
							<div className='img portrait'>
								<img src="../images/grid-SpaTreatments.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Spa Treatments" loading='lazy' />
							</div>
							<div className={`overlay-content transition-all duration-1000 ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
										<h5>
											Spa Treatments
						...
						<div className='area-box'>
							<div className='img portrait'>
								<img src="../images/grid-DeepSeaFishing.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Spa Treatments" loading='lazy' />
							</div>
							<div className={`overlay-content transition-all duration-1000 ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
										<h5>
										Deep Sea Fishing and Salt Water Fly Fishing
										</h5>
									</div>							
									<div className='content white'>
										<p>
						...
						<div className='area-box'>
							<div className='img portrait'>
								<img src="../images/grid-WhaleWatching.jpg" className='w-full h-full object-cover' width={413} height={570} alt="Spa Treatments" loading='lazy' />
							</div>
							<div className={`overlay-content transition-all duration-1000 ${(isActive) ? 'inactive' : 'active'}`}>
								<div className='details duration-300 delay-300 ease-linear'>
									<div className='title title-white mb-10 duration-300 delay-150 ease-linear'>
					...
					<div className='btn-custom text-center mt-90 lgscreen:mt-40'>
						<Link to="/" className='btn btn-blue-200-link opacity-60'>
							<span>
								Load All extra Activities
							</span>
						</Link>
					</div>
				</div>
