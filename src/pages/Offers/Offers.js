...
function Offers() {
	...
	return (
		<React.Fragment>
			...
			<section className="banner-wrapper small-banner relative">
				<div className="banner-img w-full h-full block relative overflow-hidden">
					<div className='img landscape'>
						<img src="../images/offers-banner.jpg" className='w-full h-full object-cover' width={1440} height={677} alt="Offers" loading='eager' />
					</div>
				</div>
            ...
            {/* offer grid Start */}
            <section className='offer-grid bg-white-300 py-100 lgscreen:py-50'>
                <div className='container-fluid-md'>
                    <div className='grid grid-cols-2 mdscreen:grid-cols-1 relative w-full m-0 p-0 gap-7 lgscreen:gap-10'>
                        <div className='card'>
                            <div className='img landscape mb-[32px]'>
                                <img src='../images/Stay7Pay6.jpg' width={635} height={348} loading="lazy"  alt='Stay7Pay6.jpg'/>
                            </div>
                        ...
                        <div className='card'>
                            <div className='img landscape mb-[32px]'>
                                <img src='../images/second-offer.jpg' width={635} height={348} loading="lazy"  alt=''/>
                            </div>
                            <div className='flex flex-col w-full m-0 p-0 items-center justify-center text-center relative'>
                                <div className='title title-blue-200 mb-[12px]'>
                                    <h5>
