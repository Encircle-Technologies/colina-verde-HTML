		...
		<React.Fragment>
			...
			<section className="banner-wrapper small-banner relative">
				<div className="banner-img w-full h-full block relative overflow-hidden">
					<div className='img landscape'>
						<img src="../images/travel-tips-banner.jpg" className='w-full h-full object-cover' width={1440} height={677} alt="Travel Tips" loading='eager' />
					</div>
				</div>
			...
			<section className='stay-accordion bg-white-300 relative py-100 lgscreen:py-50'>
				<div className='container-fluid-md'>
					<div className='flex flex-wrap items-center justify-between m-0 p-0 w-full relative lgscreen:gap-5 mb-60 lgscreen:mb-40'>
						<div className='block w-full lg:max-w-[70%]'>
							<div className='title title-blue-200 mb-15'>
								<h2>
                                    Helpful info for your stay with us
								</h2>
							</div>
					...
					<div className='grid md:grid-cols-2 grid-cols-1 m-0 p-0 relative gap-10 md:gap-[35px]'>
                        <div className="accordion-wrapper">
                            <div className='block w-full'>
                                <div className={`accordion-title ${isOpen ? "open" : ""}`}  onClick={() => setOpen(!isOpen)}>
                                    <div className='title title-blue-200'>
                                        <h5>
                                            Visas
                                        </h5>
                                    </div>
                                    <div className='img'>
                                        <img src='../images/arrow-up.svg' width={18} height={26} loading="lazy" alt="img" />
                                    </div> 
                                </div>
                                <div className={`accordion-item ${!isOpen ? "collapsed" : ""}`}>
                                    <div className="accordion-content content blue-100 px-[12px]">
                                        <p>
            ...
            {/* Area Grid Start */}
			<section className='stay-accordion bg-white-100 relative py-100 lgscreen:py-50'>
				<div className='container-fluid-md'>
					<div className='flex flex-wrap items-center justify-between m-0 p-0 w-full relative lgscreen:gap-5 mb-60 lgscreen:mb-40'>
						<div className='block w-full lg:max-w-[70%]'>
