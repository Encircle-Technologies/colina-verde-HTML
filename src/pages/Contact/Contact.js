...
function Contact() {
	...
	return (
		<React.Fragment>
			...
			<section className="banner-wrapper small-banner relative">
				<div className="banner-img w-full h-full block relative overflow-hidden">
					<div className='img landscape'>
						<img src="../images/contact-banner.jpg" className='w-full h-full object-cover' width={1440} height={677} alt="Contact" loading='eager' />
					</div>
				</div>
					...
					<div className='flex flex-wrap items-center w-full m-0 p-0 relative lg:gap-0 gap-8'>
						<div className='w-full lg:w-6/12 lg:order-1 order-1'>
							<div className='img portrait'>
								<img src="../images/get-In-touch.jpg" width={635} height={631} loading="lazy" alt="Get In Touch" />
							</div>
						</div>
						<div className='w-full lg:w-6/12 lg:order-2 order-2'>
							<div className='max-w-[505px] xlscreen:max-w-[373px] lgscreen:max-w-full mx-auto'>
								...
								<div className='content blue-100 mb-40 last:mb-0'>
									<p>
                                        Complete the form below to submit your queries.
									</p>
								</div>
            ...
            {/* contact info Start */}
			<section className='contact-info py-50 my-50 lgscreen:my-25 lgscreen:py-25'>
				<div className='container-fluid-md'>
					<div className='flex flex-wrap items-center justify-center w-full relative'>
                        <div className='w-full lg:max-w-[818px]'>
                            <div className='flex mdscreen:flex-col mdscreen:gap-8 flex-wrap items-center justify-center md:justify-between w-full relative'>
                                <div className='inline-block text-center mdscreen:order-1'>
                                    <div className='title title-blue-200 mb-[12px]'>
                                        <h5>
                                            Email
                                        </h5>
                                    </div>
                                    <div className='content blue-100 max-w-[246px] mx-auto'>
                                        <p>
                                            <Link to='mailto:info@colinaverdemoz.com' className='underline text-blue-100 text-opacity-75 hover:text-blue-300 duration-300 delay-150 ease-linear'>
                                                info@colinaverdemoz.com
                                            </Link>
                                        </p>
                                    </div>
                                </div>
                                <div className='inline-block text-center mdscreen:order-3'>
                                    <div className='title title-blue-200 mb-[12px]'>
                                        <h5>
                                            Address
                                        </h5>
                                    ...
                                    <div className='content blue-100 max-w-[246px] mx-auto'>
                                        <p>
                                        Site 54/55 Machangulo Peninsular, Mozambique
                                        </p>
                                    </div>
                                </div>
                                <div className='inline-block text-center mdscreen:order-2'>
                                    <div className='title title-blue-200 mb-[12px]'>
                                        <h5>
                                            Phone
                                        </h5>
                                    ...
                                    <div className='content blue-100 max-w-[246px] mx-auto'>
                                        <p>
                                            <Link to='tel:+258 84 278 0071' className='text-blue-100 text-opacity-75 hover:text-blue-300 duration-300 delay-150 ease-linear'>
                                                +258 84 278 0071
                                            </Link>
                                        </p>
                                    </div>
