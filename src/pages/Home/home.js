...
function Home() {
	...
	return (
		<React.Fragment>
			...
			{/* Banner Start */}
			<section className="banner-wrapper full-banner relative lg:h-[838px]">
				...
				<div className="banner-content flex flex-col justify-end items-center w-full h-full z-1 pb-[138px] lg:pb-[190px] absolute top-0 left-0">
			...
			<Swiper
					...
					<SwiperSlide>
						<div className='slide-box'>
							<img src='../images/stay1.jpg' width={1010} height={571} loading="lazy" alt="stay1" />
						</div>
					</SwiperSlide>
					<SwiperSlide>
						<div className='slide-box'>
							<img src='../images/stay2.jpg' width={1010} height={571} loading="lazy" alt="stay1" />
						</div>
					</SwiperSlide>
					<SwiperSlide>
						<div className='slide-box'>
							<img src='../images/stay3.jpg' width={1010} height={571} loading="lazy" alt="stay3" />
						</div>
					</SwiperSlide>
					<div className='swiper-arrow'>
						<a className='button-prev cursor-pointer absolute top-50per translate-y-minus_50 z-9 left-[128px] mdscreen:top-[50%] smscreen2:left-20' onClick={() => handlePrevClickStay(".fullbx-slider .swiper")} >
						...
						<a className='button-next cursor-pointer absolute top-50per translate-y-minus_50 z-9 right-[128px] mdscreen:top-[50%] smscreen2:right-20' onClick={() => handleNextClickStay(".fullbx-slider .swiper")} >
							<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
