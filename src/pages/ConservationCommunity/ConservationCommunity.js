...
function ConservationCommunity() {
	...
	return (
		<React.Fragment>
			...
			<section className="banner-wrapper small-banner relative">
				<div className="banner-img w-full h-full block relative overflow-hidden">
					<div className='img landscape'>
						<img src="../images/ConservationCommunity-banner.jpg" className='w-full h-full object-cover' width={1440} height={677} alt="Conservation & Community" loading='eager' />
					</div>
				</div>
					...
					<div className='flex flex-wrap items-center w-full m-0 p-0 relative lg:gap-0 gap-8'>
						<div className='w-full lg:w-6/12 lg:order-1 order-1'>
							<div className='img portrait'>
								<img src="../images/title-about-conservation-efforts.jpg" width={635} height={631} loading="lazy" alt="Title about conservation efforts" />
							</div>
						</div>
						<div className='w-full lg:w-6/12 lg:order-2 order-2'>
							<div className='max-w-[473px] xlscreen:max-w-[373px] lgscreen:max-w-full mx-auto'>
								<div className='title title-blue-100 mb-25 lgscreen:mb-15'>
									<h2>
                                        Title about conservation efforts
									</h2>
								</div>
			...
			<section className='fullbx-slider bg-white-300 fullbx-m-none relative overflow-hidden'>
                <Swiper
					autoplay={{
						delay: 2500,
				...
				<div className='container-fluid-md'>
					<div className='flex flex-wrap items-center w-full m-0 p-0 relative lg:gap-0 gap-8'>
						<div className='w-full lg:w-6/12 lg:order-2 order-1'>
							<div className='img portrait'>
								<img src="../images/estamos-juntos-community-projects.jpg" width={635} height={631} loading="lazy" alt="Estamos Juntos Community Projects" />
							</div>
						</div>
...
export default ConservationCommunity